const banip = function(n){
    ...
    <p>Чтобы разбанить его, оплатите 150 рублей штрафа.</p>
	...
	<input type="hidden" name="label" value="id=${n.user?n.user.id:'0'}&p=900&ip=${n.ip}"/>
    ...
    <div><input class="number"  type="hidden" name="sum" value="150.00" required data-type="number"/></div>
