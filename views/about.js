    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-desc">
                ...
                <p class="footer-desc__text">
                    Готовьтесь к сюрпризам и веселым беседам с незнакомцами каждый раз, когда вы нажимаете кнопку “Далее”. Откройте для себя новые увлекательные приключения!Если вы всегда мечтали пообщаться с новыми людьми, но не знали как, видеочат Rulettchatt вам в этом
                    поможет.
                </p>
                <p class="footer-desc__text">
